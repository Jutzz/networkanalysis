...
\end{figure}
Aus der Auswertung der \texttt{services} erscheint die Verfügbarkeit hoch variabel, insbesondere fällt der große Abfall nach Ende der Sommerferien auf. Da die \texttt{services} allerdings arbiträre Referenzen sind, unter denen verschiedene Mengen an tatsächlichen \texttt{trips} gruppiert sein können, ist die Anzahl der aktiven \texttt{services} nur bedingt aussagekräftig über die tatsächliche Aktivität des Netzwerks.
 Betrachtet man die Variabilität der Aktivität der Verkehre werden zwei Dinge deutlich: Es gibt stellenweise große Sprünge aktiver services, insbesondere Anfang September. Dieser Sprung ist mit einem Fahrplanwechsel nicht zu begründen, dieser findet im Nahverkehr in Nordrhein-Westfalen  dem Beginn oder Ende einer Ferienperiode oder einem Fahrplanwechsel zu begründen, 

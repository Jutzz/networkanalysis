...
Schwierigkeiten ergeben sich aus der Formulierung in der Publikation des BMDV. Auf Seite 25 ist von „einem Normalwerktag außerhalb der Ferien“ die Rede, in der Tabelle wird ein Durchschnitt über fünf Wochentage betrachtet. Da es keinen „Soll“-GTFS-Feed gibt, der einen Idealzustand des Netzes ohne Ausfälle, Baustellen, Sonderfahrten bzw. Ausfällen aufgrund von Großveranstaltungen  gibt, stellt sich zusätzlich die Frage, wie eine repräsentative Abbildung der Bedienungsqualitäten extrahiert werden kann.

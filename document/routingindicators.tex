...
\begin{figure}
	...
	\includesvg[width=0.5\linewidth]{figures/trips_year_nonholiday_weekdays_2026-05-18.svg}
	\label{fig:tripsyearrollavg2026-05-18}
\end{figure}
Aus der Auswertung der \texttt{services} erscheint die Verfügbarkeit hoch variabel, insbesondere fällt der große Abfall nach Ende der Sommerferien auf. Da die \texttt{services} allerdings arbiträre Referenzen sind, unter denen eine beliebige Anzahl tatsächlicher \texttt{trips} gruppiert sein können, ist die Zahl der aktiven \texttt{services} nur bedingt aussagekräftig über die tatsächliche Aktivität des Netzwerks. Um konkreter festzustellen, ob tatsächlich eine große Variabilität gegeben ist, wurde zusätzlich die Anzahl der \texttt{trips} pro Tag berechnet. Daraus ergibt sich ein etwas reguläreres Bild, der grundsätzliche Trend einer deutlichen Abnahme nach Ende der Sommerferien bleibt jedoch erhalten. Betrachtet man die Fahrten pro Tag getrennt nach ausführendem Verkehrsunternehmen (bzw. im Rahmen des GTFS der verantwortlichen \texttt{agency}), zeigt sich, dass die Verkehre einzelner Verkehrsunternehmen ab demm 01.09 (noch) nicht verzeichnet sind. Den größten Effekt hat dabei der Wegfall der Abbildung der Fahrten der Aachener Straßenbahn und Energieversorgungs-AG (ASEAG), die rund 5200 Fahrten pro Tag durchführt. Die Fahrten sieben weiterer Verkehrsunternehmen verschwinden im Laufe des Jahres aus dem Feed. 	Mit dieser Gewissheit können nur die Normalwerktage bis Ende Juni als Grundlage für eine repräsentative Auswertung der Abfahrten an den Stationen dienen, vor allem auch, da der Wegfall eines Verkehrsunternehmens sich nicht auf den gesamten Raum einheitlich auswirkt. Der 30.06. muss ebenfalls ausgelassen werden, das  die Sommerferien in Rheinland-Pfalz bereits am 29.06. beginnen, sodass Verkehrsunternehmen aus Rheinland-Pfalz, deren Linien über die Landesgrenze hinaus fahren bereits im Ferienfahrplan verkehren. Es bleiben daher 21 Normalwerktage in Mai und Juni, die für die Ermittlung der Bedienungsqualität genutzt werden können. Die Zahl der durchgeführten Fahrten reicht von  \num{89291} am 16.06.2026 (Dienstag) bis \num{91715} am 03.06.2026 (Mittwoch). Trotz mehrerer  Ansätze, die Variabilität einzugrenzen bleibt noch eine Verteilung von über \num{2400} Fahrten.
